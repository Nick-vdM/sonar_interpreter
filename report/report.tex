...
speed until a certain point, and then it slows down to approach the bowl.
\subsection{Calculating Variance}

\subsection{Adjustment on Kalman}


\subsection{Structure}
A core thing that makes implementing this bug free is that extracting functions
...
\begin{figure}
    \centering
    % \includegraphics{}
    \caption{Psuedo code for the controller}
    \label{controllerpsuedo}
\end{figure}
